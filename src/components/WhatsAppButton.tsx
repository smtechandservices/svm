  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`flex items-center h-14 rounded-full bg-[#25D366] shadow-lg transition-all duration-300 cursor-pointer ${open ? 'bg-[#1ebe5d]' : ''}`}
      >
        <span className={`overflow-hidden transition-all duration-300 whitespace-nowrap ${open ? 'w-36' : 'w-0'}`}>
